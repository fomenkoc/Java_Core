...
public class Application {
	public static void main(String[] args) {
		...
		int value = iOb.getOb();
		System.out.println("Value of simple generic is " + value);

		SimpleGenerics<String> sOb = new SimpleGenerics<>("Java");
		sOb.showType();

		String valueS = sOb.getOb();
		System.out.println("Value of simple generic is " + valueS);
		System.out.println();

		// with two generics
		TwoGen<Integer, String> tgObj = new TwoGen<Integer, String>(90,
				"Run Forest run");
		tgObj.showTypes();

		int valueTgObj = tgObj.getOb1();
		System.out.println("Value of generic is " + valueTgObj);

		String valueStgObj = tgObj.getOb2();
		System.out.println("Value of generic is " + valueStgObj);
		System.out.println();
