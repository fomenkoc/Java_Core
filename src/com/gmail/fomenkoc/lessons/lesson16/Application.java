...
public class Application {
	...
	System.out.println(
		"Class modifier = " + modifierText + " int = " + modifier);
	...
	Constructor<Person> singleConstructor = pc.getConstructor(String.class,
		int.class);
	...
	System.out.println("privateb Value = "
		+ privateLastNameField.get(newInstancePerson));
